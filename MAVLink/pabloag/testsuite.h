/** @file
 *	@brief MAVLink comm protocol testsuite generated from pabloag.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef PABLOAG_TESTSUITE_H
#define PABLOAG_TESTSUITE_H
...
static void mavlink_test_pabloag(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

	mavlink_test_pabloag(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_set_pid_parameters_attitude(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_pid_parameters_attitude_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0,37,104
    };
	mavlink_set_pid_parameters_attitude_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.pitch_p = packet_in.pitch_p;
        	packet1.pitch_d = packet_in.pitch_d;
        	packet1.pitch_i = packet_in.pitch_i;
        	packet1.pitch_p_sat = packet_in.pitch_p_sat;
        	packet1.pitch_d_sat = packet_in.pitch_d_sat;
        	packet1.pitch_i_sat = packet_in.pitch_i_sat;
        	packet1.roll_p = packet_in.roll_p;
        	packet1.roll_d = packet_in.roll_d;
        	packet1.roll_i = packet_in.roll_i;
        	packet1.roll_p_sat = packet_in.roll_p_sat;
        	packet1.roll_d_sat = packet_in.roll_d_sat;
        	packet1.roll_i_sat = packet_in.roll_i_sat;
        	packet1.yaw_p = packet_in.yaw_p;
        	packet1.yaw_d = packet_in.yaw_d;
        	packet1.yaw_i = packet_in.yaw_i;
        	packet1.yaw_p_sat = packet_in.yaw_p_sat;
        	packet1.yaw_d_sat = packet_in.yaw_d_sat;
        	packet1.yaw_i_sat = packet_in.yaw_i_sat;
        	packet1.height_p = packet_in.height_p;
        	packet1.height_d = packet_in.height_d;
        	packet1.height_i = packet_in.height_i;
        	packet1.height_p_sat = packet_in.height_p_sat;
        	packet1.height_d_sat = packet_in.height_d_sat;
        	packet1.height_i_sat = packet_in.height_i_sat;
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_attitude_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_attitude_pack(system_id, component_id, &msg , packet1.pitch_p , packet1.pitch_d , packet1.pitch_i , packet1.pitch_p_sat , packet1.pitch_d_sat , packet1.pitch_i_sat , packet1.roll_p , packet1.roll_d , packet1.roll_i , packet1.roll_p_sat , packet1.roll_d_sat , packet1.roll_i_sat , packet1.yaw_p , packet1.yaw_d , packet1.yaw_i , packet1.yaw_p_sat , packet1.yaw_d_sat , packet1.yaw_i_sat , packet1.height_p , packet1.height_d , packet1.height_i , packet1.height_p_sat , packet1.height_d_sat , packet1.height_i_sat , packet1.target_system , packet1.target_component );
	mavlink_msg_set_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_attitude_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pitch_p , packet1.pitch_d , packet1.pitch_i , packet1.pitch_p_sat , packet1.pitch_d_sat , packet1.pitch_i_sat , packet1.roll_p , packet1.roll_d , packet1.roll_i , packet1.roll_p_sat , packet1.roll_d_sat , packet1.roll_i_sat , packet1.yaw_p , packet1.yaw_d , packet1.yaw_i , packet1.yaw_p_sat , packet1.yaw_d_sat , packet1.yaw_i_sat , packet1.height_p , packet1.height_d , packet1.height_i , packet1.height_p_sat , packet1.height_d_sat , packet1.height_i_sat , packet1.target_system , packet1.target_component );
	mavlink_msg_set_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_pid_parameters_attitude_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_attitude_send(MAVLINK_COMM_1 , packet1.pitch_p , packet1.pitch_d , packet1.pitch_i , packet1.pitch_p_sat , packet1.pitch_d_sat , packet1.pitch_i_sat , packet1.roll_p , packet1.roll_d , packet1.roll_i , packet1.roll_p_sat , packet1.roll_d_sat , packet1.roll_i_sat , packet1.yaw_p , packet1.yaw_d , packet1.yaw_i , packet1.yaw_p_sat , packet1.yaw_d_sat , packet1.yaw_i_sat , packet1.height_p , packet1.height_d , packet1.height_i , packet1.height_p_sat , packet1.height_d_sat , packet1.height_i_sat , packet1.target_system , packet1.target_component );
	mavlink_msg_set_pid_parameters_attitude_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_onboard_pid_parameters_attitude(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_onboard_pid_parameters_attitude_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0
    };
	mavlink_onboard_pid_parameters_attitude_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.pitch_p = packet_in.pitch_p;
        	packet1.pitch_d = packet_in.pitch_d;
        	packet1.pitch_i = packet_in.pitch_i;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_attitude_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_onboard_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_attitude_pack(system_id, component_id, &msg , packet1.pitch_p , packet1.pitch_d , packet1.pitch_i , packet1.pitch_p_sat , packet1.pitch_d_sat , packet1.pitch_i_sat , packet1.roll_p , packet1.roll_d , packet1.roll_i , packet1.roll_p_sat , packet1.roll_d_sat , packet1.roll_i_sat , packet1.yaw_p , packet1.yaw_d , packet1.yaw_i , packet1.yaw_p_sat , packet1.yaw_d_sat , packet1.yaw_i_sat , packet1.height_p , packet1.height_d , packet1.height_i , packet1.height_p_sat , packet1.height_d_sat , packet1.height_i_sat );
	mavlink_msg_onboard_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_attitude_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pitch_p , packet1.pitch_d , packet1.pitch_i , packet1.pitch_p_sat , packet1.pitch_d_sat , packet1.pitch_i_sat , packet1.roll_p , packet1.roll_d , packet1.roll_i , packet1.roll_p_sat , packet1.roll_d_sat , packet1.roll_i_sat , packet1.yaw_p , packet1.yaw_d , packet1.yaw_i , packet1.yaw_p_sat , packet1.yaw_d_sat , packet1.yaw_i_sat , packet1.height_p , packet1.height_d , packet1.height_i , packet1.height_p_sat , packet1.height_d_sat , packet1.height_i_sat );
	mavlink_msg_onboard_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_onboard_pid_parameters_attitude_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_attitude_send(MAVLINK_COMM_1 , packet1.pitch_p , packet1.pitch_d , packet1.pitch_i , packet1.pitch_p_sat , packet1.pitch_d_sat , packet1.pitch_i_sat , packet1.roll_p , packet1.roll_d , packet1.roll_i , packet1.roll_p_sat , packet1.roll_d_sat , packet1.roll_i_sat , packet1.yaw_p , packet1.yaw_d , packet1.yaw_i , packet1.yaw_p_sat , packet1.yaw_d_sat , packet1.yaw_i_sat , packet1.height_p , packet1.height_d , packet1.height_i , packet1.height_p_sat , packet1.height_d_sat , packet1.height_i_sat );
	mavlink_msg_onboard_pid_parameters_attitude_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_read_pid_parameters_attitude(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_read_pid_parameters_attitude_t packet_in = {
		5,72
    };
	mavlink_read_pid_parameters_attitude_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_attitude_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_read_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_attitude_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_read_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_attitude_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_read_pid_parameters_attitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_read_pid_parameters_attitude_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_attitude_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component );
	mavlink_msg_read_pid_parameters_attitude_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_set_pid_parameters_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_pid_parameters_position_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,221,32
    };
	mavlink_set_pid_parameters_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.x_p = packet_in.x_p;
        	packet1.x_d = packet_in.x_d;
        	packet1.x_i = packet_in.x_i;
        	packet1.x_p_sat = packet_in.x_p_sat;
        	packet1.x_d_sat = packet_in.x_d_sat;
        	packet1.x_i_sat = packet_in.x_i_sat;
        	packet1.y_p = packet_in.y_p;
        	packet1.y_d = packet_in.y_d;
        	packet1.y_i = packet_in.y_i;
        	packet1.y_p_sat = packet_in.y_p_sat;
        	packet1.y_d_sat = packet_in.y_d_sat;
        	packet1.y_i_sat = packet_in.y_i_sat;
        	packet1.vel_p = packet_in.vel_p;
        	packet1.vel_d = packet_in.vel_d;
        	packet1.vel_i = packet_in.vel_i;
        	packet1.vel_p_sat = packet_in.vel_p_sat;
        	packet1.vel_d_sat = packet_in.vel_d_sat;
        	packet1.vel_i_sat = packet_in.vel_i_sat;
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_position_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_position_pack(system_id, component_id, &msg , packet1.x_p , packet1.x_d , packet1.x_i , packet1.x_p_sat , packet1.x_d_sat , packet1.x_i_sat , packet1.y_p , packet1.y_d , packet1.y_i , packet1.y_p_sat , packet1.y_d_sat , packet1.y_i_sat , packet1.vel_p , packet1.vel_d , packet1.vel_i , packet1.vel_p_sat , packet1.vel_d_sat , packet1.vel_i_sat , packet1.target_system , packet1.target_component );
	mavlink_msg_set_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.x_p , packet1.x_d , packet1.x_i , packet1.x_p_sat , packet1.x_d_sat , packet1.x_i_sat , packet1.y_p , packet1.y_d , packet1.y_i , packet1.y_p_sat , packet1.y_d_sat , packet1.y_i_sat , packet1.vel_p , packet1.vel_d , packet1.vel_i , packet1.vel_p_sat , packet1.vel_d_sat , packet1.vel_i_sat , packet1.target_system , packet1.target_component );
	mavlink_msg_set_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_pid_parameters_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_parameters_position_send(MAVLINK_COMM_1 , packet1.x_p , packet1.x_d , packet1.x_i , packet1.x_p_sat , packet1.x_d_sat , packet1.x_i_sat , packet1.y_p , packet1.y_d , packet1.y_i , packet1.y_p_sat , packet1.y_d_sat , packet1.y_i_sat , packet1.vel_p , packet1.vel_d , packet1.vel_i , packet1.vel_p_sat , packet1.vel_d_sat , packet1.vel_i_sat , packet1.target_system , packet1.target_component );
	mavlink_msg_set_pid_parameters_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_onboard_pid_parameters_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_onboard_pid_parameters_position_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0
    };
	mavlink_onboard_pid_parameters_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.x_p = packet_in.x_p;
        	packet1.x_d = packet_in.x_d;
        	packet1.x_i = packet_in.x_i;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_position_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_onboard_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_position_pack(system_id, component_id, &msg , packet1.x_p , packet1.x_d , packet1.x_i , packet1.x_p_sat , packet1.x_d_sat , packet1.x_i_sat , packet1.y_p , packet1.y_d , packet1.y_i , packet1.y_p_sat , packet1.y_d_sat , packet1.y_i_sat , packet1.vel_p , packet1.vel_d , packet1.vel_i , packet1.vel_p_sat , packet1.vel_d_sat , packet1.vel_i_sat );
	mavlink_msg_onboard_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.x_p , packet1.x_d , packet1.x_i , packet1.x_p_sat , packet1.x_d_sat , packet1.x_i_sat , packet1.y_p , packet1.y_d , packet1.y_i , packet1.y_p_sat , packet1.y_d_sat , packet1.y_i_sat , packet1.vel_p , packet1.vel_d , packet1.vel_i , packet1.vel_p_sat , packet1.vel_d_sat , packet1.vel_i_sat );
	mavlink_msg_onboard_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_onboard_pid_parameters_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_pid_parameters_position_send(MAVLINK_COMM_1 , packet1.x_p , packet1.x_d , packet1.x_i , packet1.x_p_sat , packet1.x_d_sat , packet1.x_i_sat , packet1.y_p , packet1.y_d , packet1.y_i , packet1.y_p_sat , packet1.y_d_sat , packet1.y_i_sat , packet1.vel_p , packet1.vel_d , packet1.vel_i , packet1.vel_p_sat , packet1.vel_d_sat , packet1.vel_i_sat );
	mavlink_msg_onboard_pid_parameters_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_read_pid_parameters_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_read_pid_parameters_position_t packet_in = {
		5,72
    };
	mavlink_read_pid_parameters_position_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_position_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_read_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_position_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_read_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_position_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
	mavlink_msg_read_pid_parameters_position_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_read_pid_parameters_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_read_pid_parameters_position_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component );
	mavlink_msg_read_pid_parameters_position_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_set_references_quadrotor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_references_quadrotor_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,101,168,235
    };
	mavlink_set_references_quadrotor_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.roll = packet_in.roll;
        	packet1.pitch = packet_in.pitch;
        	packet1.yaw = packet_in.yaw;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_references_quadrotor_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_references_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_references_quadrotor_pack(system_id, component_id, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.x , packet1.y , packet1.z , packet1.velocity , packet1.bitmask , packet1.target_system , packet1.target_component );
	mavlink_msg_set_references_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_references_quadrotor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.x , packet1.y , packet1.z , packet1.velocity , packet1.bitmask , packet1.target_system , packet1.target_component );
	mavlink_msg_set_references_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_references_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_references_quadrotor_send(MAVLINK_COMM_1 , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.x , packet1.y , packet1.z , packet1.velocity , packet1.bitmask , packet1.target_system , packet1.target_component );
	mavlink_msg_set_references_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_onboard_references_quadrotor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_onboard_references_quadrotor_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,101
    };
	mavlink_onboard_references_quadrotor_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.roll = packet_in.roll;
        	packet1.pitch = packet_in.pitch;
        	packet1.yaw = packet_in.yaw;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_references_quadrotor_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_onboard_references_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_references_quadrotor_pack(system_id, component_id, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.x , packet1.y , packet1.z , packet1.velocity , packet1.bitmask );
	mavlink_msg_onboard_references_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_references_quadrotor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.x , packet1.y , packet1.z , packet1.velocity , packet1.bitmask );
	mavlink_msg_onboard_references_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_onboard_references_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_references_quadrotor_send(MAVLINK_COMM_1 , packet1.roll , packet1.pitch , packet1.yaw , packet1.thrust , packet1.x , packet1.y , packet1.z , packet1.velocity , packet1.bitmask );
	mavlink_msg_onboard_references_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_set_motors_quadrotor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_motors_quadrotor_t packet_in = {
		17.0,45.0,73.0,101.0,53,120
    };
	mavlink_set_motors_quadrotor_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.ref_motor_1 = packet_in.ref_motor_1;
        	packet1.ref_motor_2 = packet_in.ref_motor_2;
        	packet1.ref_motor_3 = packet_in.ref_motor_3;
        	packet1.ref_motor_4 = packet_in.ref_motor_4;
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_motors_quadrotor_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_motors_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_motors_quadrotor_pack(system_id, component_id, &msg , packet1.ref_motor_1 , packet1.ref_motor_2 , packet1.ref_motor_3 , packet1.ref_motor_4 , packet1.target_system , packet1.target_component );
	mavlink_msg_set_motors_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_motors_quadrotor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ref_motor_1 , packet1.ref_motor_2 , packet1.ref_motor_3 , packet1.ref_motor_4 , packet1.target_system , packet1.target_component );
	mavlink_msg_set_motors_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_motors_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_motors_quadrotor_send(MAVLINK_COMM_1 , packet1.ref_motor_1 , packet1.ref_motor_2 , packet1.ref_motor_3 , packet1.ref_motor_4 , packet1.target_system , packet1.target_component );
	mavlink_msg_set_motors_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_onboard_motors_quadrotor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_onboard_motors_quadrotor_t packet_in = {
		17.0,45.0,73.0,101.0
    };
	mavlink_onboard_motors_quadrotor_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.ref_motor_1 = packet_in.ref_motor_1;
        	packet1.ref_motor_2 = packet_in.ref_motor_2;
        	packet1.ref_motor_3 = packet_in.ref_motor_3;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_motors_quadrotor_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_onboard_motors_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_motors_quadrotor_pack(system_id, component_id, &msg , packet1.ref_motor_1 , packet1.ref_motor_2 , packet1.ref_motor_3 , packet1.ref_motor_4 );
	mavlink_msg_onboard_motors_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_motors_quadrotor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ref_motor_1 , packet1.ref_motor_2 , packet1.ref_motor_3 , packet1.ref_motor_4 );
	mavlink_msg_onboard_motors_quadrotor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_onboard_motors_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_onboard_motors_quadrotor_send(MAVLINK_COMM_1 , packet1.ref_motor_1 , packet1.ref_motor_2 , packet1.ref_motor_3 , packet1.ref_motor_4 );
	mavlink_msg_onboard_motors_quadrotor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_string_message_25(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_string_message_25_t packet_in = {
		"ABCDEFGHIJKLMNOPQRSTUVWX"
    };
	mavlink_string_message_25_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_25_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_string_message_25_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_25_pack(system_id, component_id, &msg , packet1.Message );
	mavlink_msg_string_message_25_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_25_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Message );
	mavlink_msg_string_message_25_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_string_message_25_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_25_send(MAVLINK_COMM_1 , packet1.Message );
	mavlink_msg_string_message_25_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_string_message_50(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_string_message_50_t packet_in = {
		"ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVW"
    };
	mavlink_string_message_50_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_50_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_string_message_50_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_50_pack(system_id, component_id, &msg , packet1.Message );
	mavlink_msg_string_message_50_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_50_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Message );
	mavlink_msg_string_message_50_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_string_message_50_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_50_send(MAVLINK_COMM_1 , packet1.Message );
	mavlink_msg_string_message_50_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_string_message_75(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_string_message_75_t packet_in = {
		"ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUV"
    };
	mavlink_string_message_75_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        
        	mav_array_memcpy(packet1.Message, packet_in.Message, sizeof(char)*75);
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_75_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_string_message_75_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_75_pack(system_id, component_id, &msg , packet1.Message );
	mavlink_msg_string_message_75_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_75_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Message );
	mavlink_msg_string_message_75_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_string_message_75_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_75_send(MAVLINK_COMM_1 , packet1.Message );
	mavlink_msg_string_message_75_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_string_message_100(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_string_message_100_t packet_in = {
		"ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTU"
    };
	mavlink_string_message_100_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_100_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_string_message_100_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_100_pack(system_id, component_id, &msg , packet1.Message );
	mavlink_msg_string_message_100_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_100_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Message );
	mavlink_msg_string_message_100_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_string_message_100_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_string_message_100_send(MAVLINK_COMM_1 , packet1.Message );
	mavlink_msg_string_message_100_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_pabloag(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_set_pid_parameters_attitude(system_id, component_id, last_msg);
	mavlink_test_onboard_pid_parameters_attitude(system_id, component_id, last_msg);
	mavlink_test_read_pid_parameters_attitude(system_id, component_id, last_msg);
	mavlink_test_set_pid_parameters_position(system_id, component_id, last_msg);
	mavlink_test_onboard_pid_parameters_position(system_id, component_id, last_msg);
	mavlink_test_read_pid_parameters_position(system_id, component_id, last_msg);
	mavlink_test_set_references_quadrotor(system_id, component_id, last_msg);
	mavlink_test_onboard_references_quadrotor(system_id, component_id, last_msg);
	mavlink_test_set_motors_quadrotor(system_id, component_id, last_msg);
	mavlink_test_onboard_motors_quadrotor(system_id, component_id, last_msg);
	mavlink_test_string_message_25(system_id, component_id, last_msg);
	mavlink_test_string_message_50(system_id, component_id, last_msg);
	mavlink_test_string_message_75(system_id, component_id, last_msg);
	mavlink_test_string_message_100(system_id, component_id, last_msg);
